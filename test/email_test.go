...
func TestSendEmail(t *testing.T) {
	...
	cfg := smtpConfig{
		...
		from:     emailCfg.From,
		to:       "panyunpeng0703@gmail.com",
	}

	if cfg.host == "" || cfg.port == "" || cfg.username == "" || cfg.password == "" || cfg.from == "" || cfg.to == "" {
		t.Skip("please set YUKO_SMTP_HOST, YUKO_SMTP_PORT, YUKO_SMTP_USERNAME, YUKO_SMTP_PASSWORD, YUKO_SMTP_FROM and YUKO_SMTP_TO before running this test")
	}
	...
	t.Logf("email sent successfully, verify code: %s", code)
}
